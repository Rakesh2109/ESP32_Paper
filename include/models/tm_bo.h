...
#define tm_clause_add_hot        tm_bo_clause_add_hot
#define tm_clause_remove         tm_bo_clause_remove
#define tm_clause_freeze         tm_bo_clause_freeze
#define tm_clause_thaw           tm_bo_clause_thaw
#define tm_clause_activate       tm_bo_clause_activate
#define tm_clause_deactivate     tm_bo_clause_deactivate
#define tm_init                  tm_bo_legacy_init
#define tm_free                  tm_bo_legacy_free
#define tm_update                tm_bo_legacy_update
#define tm_score                 tm_bo_legacy_score
#define tm_update_words          tm_bo_legacy_update_words
#define tm_score_words           tm_bo_legacy_score_words
#define tm_reinit                tm_bo_legacy_reinit
#define tm_memory_usage          tm_bo_legacy_memory_usage
...
bool       tm_clause_remove(TM_BO* tm, uint32_t clause_id);       // free RAM
bool       tm_clause_freeze(TM_BO* tm, uint32_t clause_id);       // HOT -> COLD
bool       tm_clause_thaw(TM_BO* tm, uint32_t clause_id);         // COLD -> HOT possible
bool       tm_clause_activate(TM_BO* tm, uint32_t clause_id);     // add to active list
bool       tm_clause_deactivate(TM_BO* tm, uint32_t clause_id);   // remove from active list
...
// --- Utilities ---
uint32_t tm_bo_memory_usage_active(const TM_BO* tm);      // RAM in use for HOT
